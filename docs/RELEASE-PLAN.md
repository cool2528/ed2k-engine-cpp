...
>
> **最近更新**：2026-07-05 — P7-5 UDP + 服务器混淆 + 协商 fallback 完成：新增 aMule server UDP obfuscation codec、`server.met` obfuscation tags、`UdpServerConnection` obfuscated probe + plain fallback、HELLO obfuscation bits 与 `ServerTarget` 元数据透传；P7 全部完成，下一阶段为 P8 客户端基础设施。
