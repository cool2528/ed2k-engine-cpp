...
>
> **最近更新**：2026-07-05 — P8-5 Category + FriendList + ClientList 完成：新增分类定义/归档匹配、好友列表持久化与 friend-slot 队列优先、ClientList LRU + SourceExchange source attachment；下一实施项为 P8-6 Proxy + HTTPThread + collection + preview + scheduler + ChatRelay。
...
| **v2.1** | P8 客户端基础设施 | IPFilter + Preferences + Statistics + Category + FriendList + ClientList + Proxy + HTTPThread + .emulecollection + preview + scheduler + **ChatRelay（OP_MESSAGE 中继）**（spec/plan 已起草） | 🚧 进行中：P8-1..P8-5 ✅；P8-6 Proxy + HTTPThread + collection + preview + scheduler + ChatRelay 下一项（[spec](superpowers/specs/2026-07-04-ed2k-p8-client-infra-design.md)/[plan](superpowers/plans/2026-07-04-ed2k-p8-client-infra-impl-plan.md)） |
...
| **P8 客户端基础设施** | L7：IPFilter、Preferences、Statistics、Category、FriendList、ClientList、Proxy、HTTPThread、.emulecollection、preview、scheduler、ChatRelay | 完整客户端管理能力 | 🚧 进行中 | P8-1..P8-5 ✅；P8-6 下一项 |
