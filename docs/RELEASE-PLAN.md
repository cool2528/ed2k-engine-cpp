...
>
> **最近更新**：2026-07-06 — R1-4 M2/P1 结构 + 模式完成：`Download::run`/`peer_worker` 阶段拆分、公共 API PIMPL、`ServerConnection`/`UdpServerConnection` Observer RAII Subscription 均完成；Windows/WSL full ctest 均 450 total、441 pass + 9 live skip、0 fail。
