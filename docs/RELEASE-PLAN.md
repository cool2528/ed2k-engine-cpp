...
>
> **最近更新**：2026-07-05 — P6-5 搜索/取源/发布完成（本地提交 `a2e3ae6`）：新增 aMule-faithful Kad2 SEARCH/PUBLISH(KEY/SOURCE/NOTES) 编解码、`KadIndexed` TTL 索引与 bounded iterative `KadNetwork` 聚合搜索；下一实施项为 P6-6 Firewalled + buddies。
...
| **v1.2** | P6 KAD | Kad 路由表 + bootstrap + Kad2 UDP + 搜索/取源/发布 + buddies + notes（spec/plan 已起草） | 🚧 进行中：P6-5 ✅；P6-6 Firewalled + buddies 下一项（[spec](superpowers/specs/2026-07-04-ed2k-p6-kad-design.md)/[plan](superpowers/plans/2026-07-04-ed2k-p6-kad-impl-plan.md)） |
...
| **P6 KAD** | L5：Kad2 路由表(k-bucket)、bootstrap(nodes.dat)、Kad2 UDP、搜索/取源/发布、buddies、notes | 无服务器找源下载 | 🚧 部分完成 | P6-5 ✅；spec/plan 已起草 |
