...
>
> **最近更新**：2026-07-05 — P7-3 MD5/RC4 自带实现完成：复用既有 RFC1321 MD5，新增共享 `ed2k::crypto::RC4`（KSA/PRGA、续接、逐字节、discard）并替换 Kad UDP 私有 RC4；下一实施项为 P7-4 TCP 混淆握手 + 帧加密。
...
| **v2.0** | P7 协议混淆 | MD5/RC4 + TCP/UDP/服务器混淆 + 握手协商 + fallback（spec/plan 已起草） | 🚧 进行中：P7-1..P7-3 ✅；P7-4 TCP 混淆握手下一项（[spec](superpowers/specs/2026-07-04-ed2k-p7-obfuscation-design.md)/[plan](superpowers/plans/2026-07-04-ed2k-p7-obfuscation-impl-plan.md)） |
...
| **P7 混淆加密** | L6：MD5/RC4 自带、TCP/UDP/服务器混淆、握手协商+fallback | 兼容开启 obfuscation 的网络 | 🚧 进行中 | P7-1..P7-3 ✅；P7-4 下一项 |
