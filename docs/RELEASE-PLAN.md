...
>
> **最近更新**：2026-07-05 — P8-6 Proxy + HTTPThread + collection + preview + scheduler + ChatRelay 完成：新增 SOCKS5/HTTP CONNECT 代理、HTTP 下载、collection 文本/内部 binary round-trip、preview 请求应答、daily scheduler、ChatRelay 入站派发；下一实施项为 P8-7 集成 + CLI + live。
...
| **v2.1** | P8 客户端基础设施 | IPFilter + Preferences + Statistics + Category + FriendList + ClientList + Proxy + HTTPThread + .emulecollection + preview + scheduler + **ChatRelay（OP_MESSAGE 中继）**（spec/plan 已起草） | 🚧 进行中：P8-1..P8-6 ✅；P8-7 集成 + CLI + live 下一项（[spec](superpowers/specs/2026-07-04-ed2k-p8-client-infra-design.md)/[plan](superpowers/plans/2026-07-04-ed2k-p8-client-infra-impl-plan.md)） |
...
| **P8 客户端基础设施** | L7：IPFilter、Preferences、Statistics、Category、FriendList、ClientList、Proxy、HTTPThread、.emulecollection、preview、scheduler、ChatRelay | 完整客户端管理能力 | 🚧 进行中 | P8-1..P8-6 ✅；P8-7 下一项 |
