...
>
> **最近更新**：2026-07-05 — P8-1/P8-2 checklist 同步：P8 客户端基础设施设计 spec 与实现计划已冻结并勾选；下一实施项为 P8-3 IPFilter。
...
| **v2.1** | P8 客户端基础设施 | IPFilter + Preferences + Statistics + Category + FriendList + ClientList + Proxy + HTTPThread + .emulecollection + preview + scheduler + **ChatRelay（OP_MESSAGE 中继）**（spec/plan 已起草） | 🚧 进行中：P8-1/P8-2 ✅；P8-3 IPFilter 下一项（[spec](superpowers/specs/2026-07-04-ed2k-p8-client-infra-design.md)/[plan](superpowers/plans/2026-07-04-ed2k-p8-client-infra-impl-plan.md)） |
...
| **P8 客户端基础设施** | L7：IPFilter、Preferences、Statistics、Category、FriendList、ClientList、Proxy、HTTPThread、.emulecollection、preview、scheduler、ChatRelay | 完整客户端管理能力 | 🚧 进行中 | P8-1/P8-2 ✅；P8-3 下一项 |
