...
>
> **最近更新**：2026-07-05 — P8-7 集成 + CLI + live-gated 收尾完成：统一 CLI 全局 `--config`/`--ipfilter`/`--proxy`/`--obfuscation`，新增 collection/schedule/update-serverlist CLI，`login`/server/Kad/download 启动路径加载 Preferences + IPFilter 并支持 SOCKS5 代理登录；P8/v2.1 完成，下一阶段为 P9 eD2k 协议完备性。
