...
>
> **最近更新**：2026-07-05 — P6-1/P6-2 checklist 同步（本地提交 `6db84cb`）：P6 KAD 设计 spec 与实现计划已存在并完成起草，勾选 RELEASE-PLAN 对应项；下一实施项为 P6-3 KadID + 路由表 + nodes.dat。
...
| 2026-07-05 | **P6-1/P6-2 checklist 同步**：核对 [P6 KAD 设计 spec](superpowers/specs/2026-07-04-ed2k-p6-kad-design.md) 与 [P6 KAD 实现计划](superpowers/plans/2026-07-04-ed2k-p6-kad-impl-plan.md) 已存在并覆盖 KadID/路由表/Kad2 UDP/搜索/发布/buddies/live 计划，勾选 RELEASE-PLAN 的 P6-1/P6-2；下一项为 P6-3 KadID + 路由表 + nodes.dat。文档同步，无代码改动，沿用上一轮 `ctest -C Debug -j8 --output-on-failure`：288 测试 281 pass + 7 live skip，0 fail | `6db84cb` |
